        ...
        <div class="row">
            <div class="col-md-9">
                <form class="row g-3" action="registrarUsuario.php" method="post">
                    <div class="col-md-3">
                        <label class="form-label" for="autoSizingInput">Nombre</label>
                        <input type="text" class="form-control w-100" id="imputName" placeholder="" name="nombre">
                    </div>
                    <div class="col-md-9">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label" for="autoSizingInput">Primer apellido</label>
                        <input type="text" class="form-control w-100" id="imputAp1" placeholder="" name="apellido1">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label" for="autoSizingInput">Segundo apellido</label>
                    ...
                    <div class="col-md-3">
                        <label for="inputPhone" class="form-label">Fecha nacimiento</label>
                        <input type="date" class="form-control w-100" id="inputPhone" name="fnachi">
                    </div>
                    <div class="col-md-6">
                    </div>
                    <div class="col-md-3">
